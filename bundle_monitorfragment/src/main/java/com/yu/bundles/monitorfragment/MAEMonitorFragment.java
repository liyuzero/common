...
public class MAEMonitorFragment extends Fragment implements MAEPermissionRequest{
    ...
    public static MAEPermissionRequest getInstance(Fragment fragment){
        if(fragment != null && fragment.isAdded() && fragment.getActivity() != null){
            initTargetSDKVersion(fragment.getActivity().getApplicationInfo());
            FragmentManager manager = fragment.getChildFragmentManager();
            return getMAEMonitorFragment(manager);
        } else {
    ...
    private static MAEMonitorFragment getMAEMonitorFragment(FragmentManager fragmentManager) {
        MAEMonitorFragment fragment = (MAEMonitorFragment) fragmentManager.findFragmentByTag(MONITOR_FRAGMENT_TAG);
        if(fragment == null){
